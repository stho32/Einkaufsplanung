...
QUnit.test("Rendern der Einkaufsliste als HTML-Tabelle (Einzelpreis)", function(assert) {
    ...
    var renderer = EinkaufslisteAlsEinzelpreisHtmlTabelleRenderer(einkaufsliste);

    var html = renderer.Render();

    $("#testzwischenausgabe").append("<strong>EinkaufslisteAlsEinzelpreisHtmlTabelleRenderer / Gurkenwurstbrot</strong><br/>")
        .append(html);
